...
<div class="container" id="main-container">
    @include('syntara::layouts.dashboard.confirmation-modal', array('title' => trans('syntara::all.confirm-delete-title'), 'content' => trans('syntara::all.confirm-delete-message'), 'type' => 'delete-occupancies'))
        ...
        <div class="col-lg-10">
            <section class="module">
                <div class="module-head">
                    <b>{{ trans('syntara::occupancies.list') }}</b>
                </div>
                <div class="module-body ajax-content">
                    @include('occupancies.list-occupancies')
                </div>
            </section>
        </div>
        {{-- <div class="col-lg-2">
