...
@include('syntara::layouts.dashboard.confirmation-modal', array('title' => trans('syntara::all.confirm-delete-title'), 'content' => trans('syntara::rooms.confirm-delete-message'), 'type' => 'delete-room-availability'))
        ...
        <div class="col-lg-10">
            <section class="module">
                ...
                <div class="module-body ajax-content">
                    @include('roomavailabilities.list-roomavailabilities')
                </div>
            </section>
        </div>
        <div class="col-lg-2">
