...
class RoomSurchargeController extends \BaseController {
	...
	public function index()
	{
            ...
            $roomsurcharges = DB::select(RoomSurcharge::getQueryRoomSurcharge());
            $roompricedate = DB::select(RoomSurcharge::getQueryRoomSurchargeDate());
            $this->getRoomSurchargeDate($roomsurcharges, $roompricedate);
            
            if(Request::ajax())
            {
                $html = View::make('roomprices.list-roomprices')->with('roomprices', $roomsurcharges)->render();
                return Response::json(array('html' => $html));
            }
            
            $this->layout = View::make('roomprices.index-roomprice')->with('roomprices', $roomsurcharges)->with('roompricedate', $roompricedate);
            $this->layout->title = trans('syntara::roomprices.list');
            $this->layout->breadcrumb = Config::get('syntara::breadcrumbs.room-price');
	}
        
        public function getRoomSurchargeDate($roomsurcharges, $roompricedate)
        {
            $allDate = null;
            foreach($roomsurcharges as $roomprice)
            {
	...
	public function create()
	{
            ...
            $roomsurcharges = RoomSurcharge::all();
            $roomtypes = RoomType::lists('roomtype_name', 'roomtype_id');
            
            $this->layout = View::make('roomprices.new-roomprice', array('roomprices' => $roomsurcharges, 'roomtypes' => $roomtypes));
        ...
        public function setDetailPrice($roomtypeId)
        {
            ...
            if(Request::ajax())
            {
                //$html = View::make('roomprices.new-roomprice')->with('roomtypes', $roomtypes)->with('roomprices', $roomsurcharges)->with('occupancies', $occupancies)->render();
	...
	public function store($occupancies)
	{
            ...
            return json_encode(array('roomPriceCreated' => true, 'redirectUrl' => URL::route('listRoomSurcharges')));
	}
	...
	{   
            $occupancy = RoomSurcharge::find($id);
	...
	public function delete($id)
	{
            ...
            {
                return Response::json(array('deleteRoomSurcharge' => false, 'message' => trans('syntara::roomprices.messages.not-found'), 'messageType' => 'danger'));
            }
            return Response::json(array('deleteRoomSurcharge' => true, 'message' => trans('syntara::roomprices.messages.remove-success'), 'messageType' => 'success'));
	}
